...
class AssetTransfer extends Contract {
    ...
    async CreatePrivateTransaction(ctx, ownerOrgId, newOwnerOrgId, transactionId, assetIds, newOwnerMSP) {
        ...
        try {
            ...
            await ctx.stub.putPrivateData(collectionName, transactionId, JSON.stringify({ id: transactionId, assetIds: assetDetails, newOwnerMSP, isNewOwnerAccepted: false, isCurrentOwnerApproved: false, isCancelled: false, isReturned: false, cancelledAt: 0, returnedAt: 0, reasonForReturn: "", ownerOrgId, newOwnerOrgId, isOwnershipChanged: false, created: ctx.stub.getTxTimestamp().array[0] }));
